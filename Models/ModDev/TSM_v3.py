...
class SizeModLogspace:
    ...
    def __init__(self, mld, par, sst, dmdt, N0=1., minP=0., maxP=2., numP=3, minZ=5, maxZ=400, numZ=2, numYears=5,
                 ...
                 topt_alpha=-0.145, topt_beta=39.52, sig_T=30,
                 graz_alpha=-0.4, graz_beta=26, ops_alpha=0.56, ops_beta=0.65, graz_Q10=3,
                 SizeTol=[0.2, 0.5]):
        self.mld = mld
        ...
        self.solution = odeint(self.AlloNPsZD, self.init_con, self.t_array, rtol=1.e-5, atol=1.e-5, hmax=1.e16, hmin=1.e-16)
