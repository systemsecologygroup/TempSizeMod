...
class SizeModLogspace:
    ...
    def __init__(self, mld, par, sst, dmdt, N0=1., minP=0., maxP=2., numP=3, minZ=5, maxZ=400, numZ=2, numYears=5,
                 ...
                 graz_alpha=-0.4, graz_beta=26, ops_alpha=0.56, ops_beta=0.65, topt_alpha=-0.145, topt_beta=39.52, sig_T=30,
                 SizeTol=[0.2, 0.5]):
        self.mld = mld
    ...
    def AlloNPsZD(self, y, t):
        ...
        for i in range(len(Ps)):
            ...
            # [dNdt]
            var[0] = (var[0]
                      - self.Allo_mumax(Psize) * (self.temp_dependence(self.sst[t], self.Allo_Topt(Psize)) * self.Allo_NU(N, Psize) *
